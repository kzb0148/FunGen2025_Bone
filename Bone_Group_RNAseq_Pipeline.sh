...
## Parameters below were used to submit this script:
## 		queue: bigmem
##		core: 12
...
## Make variable for your group's SCRATCH folder so the directories are automatically made in the group directory
MyID=Bones_group        
...
RESULTSD=/scratch/$MyID/Counts_2025     
...
fasterq-dump SRR8996993
fasterq-dump SRR5889310
fasterq-dump SRR8997013
fasterq-dump SRR22459521
fasterq-dump SRR8996955
fasterq-dump SRR22459525
...
cp /home/aubclsd0318/class_shared/AdaptersToTrim_All.fa . 
...
cp /home/aubclsd0318/ncbi_dataset/data/GCF_000002285.5/${REF}.fna .
...
## Run the python script prepDE.phy to prepare you data for downstream analysis (converts the files in your Ballgown folder to a count matrix)
cp /home/aubclsd0318/class_shared/prepDE.py3 .
